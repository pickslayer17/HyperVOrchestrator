...
- Перед внесением изменений в код сначала опишите предполагаемое редактирование и дождитесь явного одобрения пользователя. Предпочитайте минимальные решения на PowerShell и избегайте кода interop/helper, когда достаточно прямого обновления переменной окружения.
